...
const s=StyleSheet.create({row:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:spacing.md},title:{color:colors.text,fontSize:20,fontWeight:'700'},action:{color:colors.deepGreen,fontSize:14,fontWeight:'700'}});
