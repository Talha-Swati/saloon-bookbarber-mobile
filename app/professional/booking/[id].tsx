...
const s = StyleSheet.create({header:{flexDirection:"row",alignItems:"center",justifyContent:"space-between"},backButton:{width:44,height:44,alignItems:"center",justifyContent:"center"},back:{fontSize:34,color:colors.text,lineHeight:38},navTitle:{fontSize:19,fontWeight:"800",color:colors.text},kicker:{color:colors.primary,fontSize:11,fontWeight:"800",letterSpacing:1,marginTop:spacing.lg},heading:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:spacing.md,marginTop:6,marginBottom:spacing.lg},title:{fontSize:27,fontWeight:"800",color:colors.text,flex:1},status:{color:colors.dark,backgroundColor:colors.soft,borderRadius:radius.pill,paddingHorizontal:9,paddingVertical:6,fontSize:9,fontWeight:"800"},card:{backgroundColor:colors.surface,borderWidth:1,borderColor:colors.border,borderRadius:radius.md,paddingHorizontal:spacing.md},row:{flexDirection:"row",justifyContent:"space-between",gap:spacing.md,paddingVertical:13,borderBottomWidth:1,borderBottomColor:colors.border},muted:{color:colors.muted},value:{color:colors.text,fontWeight:"700",flex:1,textAlign:"right"},section:{color:colors.text,fontSize:18,fontWeight:"800",marginTop:spacing.lg,marginBottom:spacing.sm},timeline:{paddingLeft:4},event:{flexDirection:"row",alignItems:"center",gap:10,minHeight:34},dot:{width:10,height:10,borderRadius:5,backgroundColor:colors.border},dotOn:{backgroundColor:colors.primary},eventText:{color:colors.muted},eventTextOn:{color:colors.text,fontWeight:"700"},actions:{flexDirection:"row",gap:spacing.sm,flexWrap:"wrap"},action:{minHeight:48,backgroundColor:colors.primary,borderRadius:radius.sm,alignItems:"center",justifyContent:"center",paddingHorizontal:spacing.lg,flexGrow:1},secondary:{backgroundColor:colors.surface,borderWidth:1,borderColor:colors.border},actionText:{color:"#FFF",fontWeight:"800"},secondaryText:{color:colors.text},empty:{color:colors.muted,textAlign:"center",marginTop:spacing.xl}});
